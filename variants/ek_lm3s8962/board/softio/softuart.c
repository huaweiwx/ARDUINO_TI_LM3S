...
SoftUARTConfigSet(tSoftUART *pUART, unsigned long ulConfig)
{
    ...
    if(pUART->ulTxGPIO != 0)
    {
        ...
        //
        GPIOPinTypeGPIOOutput(pUART->ulTxGPIO & 0xfffff000,
    ...
    if(pUART->ulRxGPIOPort != 0)
    {
        ...
        //
        GPIOPinTypeGPIOInput(pUART->ulRxGPIOPort, pUART->ucRxPin);

        //
        // Set the Rx pin to generate an interrupt on the next falling edge.
        //
        GPIOIntTypeSet(pUART->ulRxGPIOPort, pUART->ucRxPin,
                           GPIO_FALLING_EDGE);

        //
        // Enable the Rx pin interrupt.
        //
        GPIOPinIntClear(pUART->ulRxGPIOPort, pUART->ucRxPin);
        GPIOPinIntEnable(pUART->ulRxGPIOPort, pUART->ucRxPin);
    }
...
//*****************************************************************************
unsigned long
SoftUARTRxTick(tSoftUART *pUART, unsigned char bEdgeInt)
{
    ...
    //
    ulPinState = GPIOPinRead(pUART->ulRxGPIOPort, pUART->ucRxPin);
    ...
    switch(pUART->ucRxState)
    {
        ...
        case SOFTUART_RXSTATE_IDLE:
        {
            ...
            //
            GPIOPinIntClear(pUART->ulRxGPIOPort, pUART->ucRxPin);
            GPIOPinIntDisable(pUART->ulRxGPIOPort, pUART->ucRxPin);
...
//*****************************************************************************
void
SoftUARTBreakCtl(tSoftUART *pUART, unsigned char bBreakState)
{
    //
...
//*****************************************************************************
unsigned long
SoftUARTIntStatus(tSoftUART *pUART, unsigned char bMasked)
{
    //
