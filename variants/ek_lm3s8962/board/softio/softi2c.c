    ...
    switch(pI2C->ucState)
    {
        ...
        case SOFTI2C_STATE_ADDR0:
        {
            ...
            else
            {
                ...
                //
                GPIODirModeSet(pI2C->ulSDAGPIO & 0xfffff000,
...
SoftI2CInit(tSoftI2C *pI2C)
{
    ...
    //
    GPIODirModeSet(pI2C->ulSCLGPIO & 0xfffff000,
                       (pI2C->ulSCLGPIO & 0x00000fff) >> 2, GPIO_DIR_MODE_OUT);
    GPIOPadConfigSet(pI2C->ulSCLGPIO & 0xfffff000,
    ...
    GPIOPadConfigSet(pI2C->ulSDAGPIO & 0xfffff000,
                         (pI2C->ulSDAGPIO & 0x00000fff) >> 2,
                         GPIO_STRENGTH_8MA, GPIO_PIN_TYPE_OD);
...
//*****************************************************************************
unsigned char
SoftI2CIntStatus(tSoftI2C *pI2C, unsigned char bMasked)
{
    //
