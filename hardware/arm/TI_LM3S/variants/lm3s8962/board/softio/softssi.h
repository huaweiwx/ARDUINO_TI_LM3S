...
//
//*****************************************************************************
extern unsigned char SoftSSIBusy(tSoftSSI *pSSI);
...
extern void SoftSSIConfigSet(tSoftSSI *pSSI, unsigned char ucProtocol,
                             unsigned char ucBits);
extern unsigned char SoftSSIDataAvail(tSoftSSI *pSSI);
...
extern unsigned long SoftSSIIntStatus(tSoftSSI *pSSI, unsigned char bMasked);
...
extern void SoftSSIRxGPIOSet(tSoftSSI *pSSI, unsigned long ulBase,
                             unsigned char ucPin);
extern unsigned char SoftSSISpaceAvail(tSoftSSI *pSSI);
