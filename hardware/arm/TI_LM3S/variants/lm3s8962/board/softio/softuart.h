...
extern unsigned char SoftUARTCharsAvail(tSoftUART *pUART);
extern unsigned char SoftUARTSpaceAvail(tSoftUART *pUART);
extern long SoftUARTCharGetNonBlocking(tSoftUART *pUART);
extern long SoftUARTCharGet(tSoftUART *pUART);
extern unsigned char SoftUARTCharPutNonBlocking(tSoftUART *pUART,
                                           unsigned char ucData);
extern void SoftUARTCharPut(tSoftUART *pUART, unsigned char ucData);
extern void SoftUARTBreakCtl(tSoftUART *pUART, unsigned char bBreakState);
extern unsigned char SoftUARTBusy(tSoftUART *pUART);
...
extern unsigned long SoftUARTIntStatus(tSoftUART *pUART, unsigned char bMasked);
...
extern unsigned long SoftUARTRxTick(tSoftUART *pUART, unsigned char bEdgeInt);
