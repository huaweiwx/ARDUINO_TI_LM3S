                 ...
                 unsigned char ucBits)
{
    ...
    if(pSSI->ulFssGPIO != 0)
    {
        ...
        //
        GPIOPinTypeGPIOOutput(pSSI->ulFssGPIO & 0xfffff000,
    ...
    //
    GPIOPinTypeGPIOOutput(pSSI->ulClkGPIO & 0xfffff000,
    ...
    //
    GPIOPinTypeGPIOOutput(pSSI->ulTxGPIO & 0xfffff000,
    ...
    if(pSSI->ulRxGPIO != 0)
    {
        ...
        //
        GPIOPinTypeGPIOInput(pSSI->ulRxGPIO & 0xfffff000,
...
//*****************************************************************************
unsigned long
SoftSSIIntStatus(tSoftSSI *pSSI, unsigned char bMasked)
{
    //
